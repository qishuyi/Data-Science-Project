...
library(ggplot2)
library(maps)
obesity <- read.csv("https://raw.githubusercontent.com/qishuyi/First-Data-Science-Project/master/Nutrition__Physical_Activity__and_Obesity_-_Women__Infant__and_Child.csv", header = TRUE)
policies <- read.csv("https://raw.githubusercontent.com/qishuyi/First-Data-Science-Project/master/Nutrition__Physical_Activity__and_Obesity_-_Policy_and_Environmental_Data.csv", header = TRUE)
```
```{r}
...
scat <- ggplot(data=obesity2012) +
        ...
        labs(x = "Number of farmers' market with SNAP (per 100,000 residents)", 
             ...
             color = "Adopted complete streets policy",
